...
from app.api.admin.instructions import router as admin_instructions_router
from app.api.tenant.documents import router as tenant_documents_router
from app.api.tenant.instructions import router as tenant_instructions_router
...
api_router.include_router(admin_instructions_router, prefix="/admin")
...
api_router.include_router(tenant_instructions_router)
